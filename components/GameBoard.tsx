...
const LEVEL_DATA: Record<number, number[][]> = {
  ...
  8: [
    ...
    [11,  0,  5,  5,  5,  5,  5,  5, 20,  0, 11],
    [11,  0,  0,  0,  0,  0,  0,  0,  6,  0, 11],
    [11,  0, 21,  5,  5,  5, 20,  0,  6,  0, 11],
    [11,  0, 52,  0,  0,  0,  6,  0,  6,  0, 11],
    [11,  0, 24,  5, 20,  0,  6,  0, 24, 43,  8],
    [11,  0, 51,  0,  6,  0,  6,  0,  6,  0, 11],
    [11,  0,  6,  4,  6, 33,  6, 32,  6, 31, 11],
    [15, 12,  9, 12,  9, 12,  9, 12,  9, 12, 14],
  ],
  ...
  10: [
    [13, 12, 12, 12, 12, 12, 12, 10, 12, 12, 16, -1],
    [11,  0,  0,  0,  0,  0,  0, 58,  0, 36, 11, -1],
    [11,  0, 21,  5,  5, 20,  0,  6,  0,  0, 11, -1],
    [11,  0,  6, 31,  0, 53,  0, 24, 47,  5, 22, 16],
    [11,  0, 24, 42,  5, 23,  0, 56,  0,  0, 17, 11],
    [11,  0,  6, 38,  0,  6,  0, 19,  5,  5,  5,  8],
    [11, 35,  6,  0,  0,  6,  0,  0,  0,  0,  0, 11],
    [ 7, 44, 22,  5, 41, 22,  5, 25,  5, 20,  0, 11],
    [11,  0,  0,  0,  0,  0,  0,  6, 33,  6,  0, 11],
    [15, 12, 12, 12, 12, 20,  0, 55,  0,  6,  0, 11],
    [-1, -1, -1, -1, -1,  6,  0, 19,  5, 18,  0, 11],
...
export default function GameBoard({ level, onWin }: GameBoardProps) {
  ...
  return (
    <div className="relative w-full max-w-[1290px] h-[50vh] sm:h-[75vh] min-h-[260px] min-h-[320px] max-h-[600px] border border-white/10 bg-transparent rounded-xl flex items-center justify-center shadow-2xl overflow-hidden"> 
